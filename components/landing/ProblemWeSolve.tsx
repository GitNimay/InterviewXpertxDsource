...
import { AlertCircle, FileWarning, Frown, Scale } from 'lucide-react';
    ...
    <section className="py-20 md:py-32 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-10">
          ...
          <div className="bg-white/50 dark:bg-[#121216]/80 backdrop-blur-xl border border-slate-200 dark:border-white/5 rounded-3xl p-8 shadow-xl hover:shadow-2xl hover:border-blue-500/30 transition-all duration-300 md:col-span-2 lg:col-span-1">
          ...
          <div className="bg-white/50 dark:bg-[#121216]/80 backdrop-blur-xl border border-slate-200 dark:border-white/5 rounded-3xl p-8 shadow-xl hover:shadow-2xl hover:border-purple-500/30 transition-all duration-300 md:col-span-2 lg:col-span-1">
            <div className="w-full mb-6">
              <h3 className="text-xl font-bold text-slate-900 dark:text-white flex items-center gap-2 mb-2">
